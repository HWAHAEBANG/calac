...
const SignUpSection = () => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post("http://calac-env.eba-pyefrphs.ap-northeast-2.elasticbeanstalk.com/api/login/insert", {
        id,
        pwd,
        name,
        birth,
  ...
  const handleNotDuplicated = () => {
    axios
      .get(`http://calac-env.eba-pyefrphs.ap-northeast-2.elasticbeanstalk.com/api/login/duplicatedId?inputId=${signUpInfo.id}`)
      .then((response) => {
